# IETF 126 Side Meeting — A Taxonomy to Organize Agentic AI Use Cases in the IETF
...
- Various authors to present their agentic AI use cases and illustrate how to apply the taxonomy.
...
### 3.1 Welcome and Recap (5 min)

- Note Well, Agenda Bash and Problem Motivation
- Goals of the effort and progress since IETF 125.
- Summary of the June 25 virtual side meeting outcomes.

### 3.2 Taxonomy Structure Walkthrough 
- Seven top-level domains: Transport, Security and Trust, Discovery, Identity, Coordination and Orchestration, Data and Context Management, Operations and Management.
